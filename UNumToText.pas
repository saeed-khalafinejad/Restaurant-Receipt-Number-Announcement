...
begin
 ...
 else raise Exception.Create('Œ«—Ã «“ „ÕœÊœÂ');
end;
...
const ARR: TArrString2to9 = ('»Ì” ','”Ì','çÂ·','Å‰Ã«Â','‘’ ','Â› «œ',
     'Â‘ «œ','‰Êœ');
begin
 result:=ARR;
end;
...
const ARR: TArrString2to9 = ('»Ì”  Ê','”Ì Ê','çÂ· Ê','Å‰Ã«Â Ê','‘’  Ê','Â› «œ Ê',
     'Â‘ «œ Ê','‰Êœ Ê');
begin
 result:=ARR;
end;
...
const ARR: TArrString0to19 = ('’›—','Ìò','œÊ','”Â','çÂ«—','Å‰Ã',
     '‘‘','Â› ','Â‘ ','‰Â','œÂ','Ì«“œÂ','œÊ«“œÂ','”Ì“œÂ',
     'çÂ«—œÂ','Å«‰“œÂ','‘«‰“œÂ','Â›œÂ','ÂÌÃœÂ','‰Ê“œÂ');
begin
 result:=ARR;
end;

function TNumToText.CHundreds: TArrString1to9;
const ARR: TArrString1to9 = ('Ìò’œ','œÊÌ” ','”Ì’œ','çÂ«—’œ','Å«‰’œ','‘‘’œ',
     'Â› ’œ','Â‘ ’œ', '‰Â’œ');
begin
 result:=ARR;
end;
...
const ARR: TArrString1to9 = ('Ìò’œ Ê','œÊÌ”  Ê','”Ì’œ Ê','çÂ«—’œ Ê','Å«‰’œ Ê',
     '‘‘’œ Ê','Â› ’œ Ê','Â‘ ’œ Ê', '‰Â’œ Ê');
begin
 result:=ARR;
end;
...
begin
 if ((num<0)or(num>999999)) then
  raise Exception.Create('⁄œœ »«Ì” Ì »Ì‰ 1  « 999999 »«‘œ');
end;
